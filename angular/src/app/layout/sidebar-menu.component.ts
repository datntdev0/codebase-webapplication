...
export class SidebarMenuComponent extends AppComponentBase implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.router.events.subscribe(this.handleOnRouteChange);
  }
  ...
  handleOnRouteChange = (event?: NavigationEnd) => {
    const currentUrl = event?.url ? event.url : location.pathname;
    const primaryUrlSegmentGroup = this.router.parseUrl(currentUrl)
